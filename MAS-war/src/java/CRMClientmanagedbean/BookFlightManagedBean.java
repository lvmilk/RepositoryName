 ...
 * @author LIU YUQI'
 */
@Named(value = "bookFlight")
@ViewScoped
public class BookFlightManagedBean implements Serializable {
...
//        secondFrequency = rf.getSecondFrequency(origin);
    ...
    public void findFlightInstanceBack() throws IOException {
