...
//                    || reqURI.indexOf("/forgetPwd") >= 0 || reqURI.contains("/CMIpages/")|| reqURI.equals("/MAS-war/")|| reqURI.contains("Permission.xhtml")) {
//                
...
//                chain.doFilter(request, response);
//            } else if (stfType.equals("officeStaff") && reqURI.contains("staffWorkspace.xhtml")) {
//                System.out.println("inside admin-else");
//                chain.doFilter(request, response);
//                
//            } else {
//                request.getRequestDispatcher("/Permission.xhtml").forward(request, response);
////                res.sendRedirect(req.getContextPath() + "/Permission.xhtml");
//            }
