...
INSERT IGNORE INTO Airport (IATA, airportName,cityName, countryCode,spec, timeZone,opStatus,strategicLevel, airspace) values("SIN","Changi","Singapore","SG","spec1","UTC+08:00","opstatus1","strlevel1","airspace1")
INSERT IGNORE INTO Airport (IATA, airportName,cityName, countryCode,spec, timeZone,opStatus,strategicLevel, airspace) values("XIA","Xianyang","Xi'an","CN","spec2","UTC+08:00","opstatus2","strlevel2","airspace2")
