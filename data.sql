INSERT IGNORE INTO AircraftType (type, manufacturer, maxDistance, purchaseCost, fuelCost, mtCost, aircraftLength, wingspan, minAirspace, suiteNo, fcSeatNo,bcSeatNo,pecSeatNo,ecSeatNo, cabinCrew, purser, captain, pilot, acInH, acInC, acDu, acMH, bcInH, bcInC, bcDu, bcMH, ccInH, ccInC, ccDu, ccMH, dcInH, dcInC, dcDu, dcMH) values("A380","AIRBUS",15200,200000000,12000,80,75,2000,"4E",6,10,20,50,300,0.02,0.005,2,2, 300,60,24,240,2000,400,48,600,8000,1600,336,3000,36000,6100,1440,50000)
INSERT IGNORE INTO AircraftType (type, manufacturer, maxDistance, purchaseCost, fuelCost, mtCost, aircraftLength, wingspan, minAirspace, suiteNo, fcSeatNo,bcSeatNo,pecSeatNo,ecSeatNo, cabinCrew, purser, captain, pilot, acInH, acInC, acDu, acMH, bcInH, bcInC, bcDu, bcMH, ccInH, ccInC, ccDu, ccMH, dcInH, dcInC, dcDu, dcMH) values("777-300","BOEING",11400,150000000,10000,70,67,1500,"4F",3,20,50,100,200,0.02,0.005,1,2, 300,36,20,200,1800,360,40,500,7500,1500,240,2500,30000,6000,1200,45000)
INSERT IGNORE INTO AircraftType (type, manufacturer, maxDistance, purchaseCost, fuelCost, mtCost, aircraftLength, wingspan, minAirspace, suiteNo, fcSeatNo,bcSeatNo,pecSeatNo,ecSeatNo, cabinCrew, purser, captain, pilot) values("A330-200","AIRBUS",10800,50000000,6000,60,55,800,"4F",2,10,50,80,200,0.02,0.005,2,2)
...
INSERT IGNORE INTO Officestaff(OFFNAME,EMAIL,OFFPASSWORD,STFTYPE,ATTEMPT,LOCKED,USER_USERNAME,NAME,STFLEVEL,SALARY,HOURPAY) values("O777777","777@777.com","72ebb4d2f49358f09e1811874bb487d1","officeStaff",0,0,"O777777","HAO","Normal",5000,0)
INSERT IGNORE INTO Officestaff(OFFNAME,EMAIL,OFFPASSWORD,STFTYPE,ATTEMPT,LOCKED,USER_USERNAME,NAME,STFLEVEL,SALARY,HOURPAY) values("O888888","888@888.com","0e267f2d45cd249730ca941395119dec","officeStaff",0,0,"O888888","LI","Normal",5000,0)

INSERT IGNORE INTO Groundstaff(GRDNAME,EMAIL,GRDPASSWORD,STFTYPE,ATTEMPT,LOCKED,USER_USERNAME,NAME,STFLEVEL,SALARY,HOURPAY) values("G777777","111@111.com","de581c8f145c1fb4114c34405b17a479","groundStaff",0,0,"G777777","HAO","Normal",5000,0)
INSERT IGNORE INTO Groundstaff(GRDNAME,EMAIL,GRDPASSWORD,STFTYPE,ATTEMPT,LOCKED,USER_USERNAME,NAME,STFLEVEL,SALARY,HOURPAY) values("G888888","222@222.com","d3e68babfccc6540105b8a6e8c2f017a","groundStaff",0,0,"G888888","LI","Normal",5000,0)

INSERT IGNORE INTO Cabincrew(CBNAME,CBPASSWORD,EMAIL,STFTYPE,ATTEMPT,LOCKED,USER_USERNAME,NAME,STFLEVEL,SALARY,HOURPAY) values("CB777777","a9e82ba9d07b46fb5ae7ad1bb15bcc26","333@333.com","cabin",0,0,"CB777777","HAO","Cabin Leader",10000,0)
INSERT IGNORE INTO Cabincrew(CBNAME,CBPASSWORD,EMAIL,STFTYPE,ATTEMPT,LOCKED,USER_USERNAME,NAME,STFLEVEL,SALARY,HOURPAY) values("CB888888","d77c897797e7edf03bf5cd8509493314","444@444.com","cabin",0,0,"CB888888","LI","Cabin",8000,0)

INSERT IGNORE INTO Cockpitcrew(CPNAME,CPPASSWORD,EMAIL,STFTYPE,LICENCE,ATTEMPT,LOCKED,USER_USERNAME,NAME,STFLEVEL,SALARY,HOURPAY) values("CP777777","829d214cbc0fd94b7e16a52e526d3a56","555@555.com","cockpit","L12345",0,0,"CP777777","HAO","Captain",20000,0)
INSERT IGNORE INTO Cockpitcrew(CPNAME,CPPASSWORD,EMAIL,STFTYPE,LICENCE,ATTEMPT,LOCKED,USER_USERNAME,NAME,STFLEVEL,SALARY,HOURPAY) values("CP888888","91da5b4c6cb97677b5b66f0f07ef993b","666@666.com","cockpit","L12345",0,0,"CP888888","LI","Pilot",15000,0)
