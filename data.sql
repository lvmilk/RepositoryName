...
INSERT IGNORE INTO FlightFrequency(id,route_id, flightNo, scheduleDepTime, scheduleArrTime, dateAdjust, onMon,  onTue, onWed, onThu,  onFri, onSat, onSun, startDate, endDate) values (2,2, "MR001", "07:45", "13:35", 0, TRUE, FALSE, TRUE, FALSE, TRUE, FALSE, TRUE, "2015-09-01", "2016-03-01")
INSERT IGNORE INTO FlightFrequency(id,route_id, flightNo, scheduleDepTime, scheduleArrTime, dateAdjust, onMon,  onTue, onWed, onThu,  onFri, onSat, onSun, startDate, endDate) values (3,3, "MR002", "06:10", "11:20", 0, TRUE, FALSE, TRUE, FALSE, TRUE, FALSE, TRUE, "2015-09-01", "2016-03-01")
